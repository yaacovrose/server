...
var mongoose_dal_1 = require("./mongoose_dal");
var getAllProducts = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_dal_1.default.getAllProducts()];
            case 1:
                allProducts = _a.sent();
...
var getProductsByCategory = function (category) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_dal_1.default.getProductsByCategory(category)];
            case 1:
                products = _a.sent();
                if (products) {
                    return [2 /*return*/, products];
                }
                return [2 /*return*/, "category not found"];
            case 2:
                err_2 = _a.sent();
                throw err_2;
            case 3: return [2 /*return*/];
